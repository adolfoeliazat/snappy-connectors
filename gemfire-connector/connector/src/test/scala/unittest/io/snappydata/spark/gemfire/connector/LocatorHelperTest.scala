...
import io.snappydata.spark.gemfire.connector.internal.LocatorHelper
...
class LocatorHelperTest extends FunSuite {
  ...
  test("parseLocatorsString with invalid locator(s)") {
    ...
    intercept[Exception] {
      LocatorHelper.parseLocatorsString("")
    }
    intercept[Exception] {
      LocatorHelper.parseLocatorsString(null)
    }
    // 1 bad locatorStr
    intercept[Exception] {
  ...
  test("pickPreferredGeodeServers: io.snappydata.spark.gemfire.connector.internal.gemfirefunctions.shared servers and one gf-server per host") {
  ...
  test("pickPreferredGeodeServers: io.snappydata.spark.gemfire.connector.internal.gemfirefunctions.shared servers, one gf-server per host, un-sorted list") {
    val (srv1, srv2, srv3, srv4) = (("host1", 4001), ("host2", 4002), ("host3", 4003), ("host4", 4004))
  ...
  test("pickPreferredGeodeServers: io.snappydata.spark.gemfire.connector.internal.gemfirefunctions.shared servers and two gf-server per host") {
  ...
  test("pickPreferredGeodeServers: io.snappydata.spark.gemfire.connector.internal.gemfirefunctions.shared servers, two gf-server per host, un-sorted server list") {
    val (srv1, srv2, srv3, srv4) = (("host1", 4001), ("host1", 4002), ("host2", 4003), ("host2", 4004))
  ...
  test("pickPreferredGeodeServers: no io.snappydata.spark.gemfire.connector.internal.gemfirefunctions.shared servers and one gf-server per host") {
    val (srv1, srv2, srv3, srv4) = (("host1", 4001), ("host2", 4002), ("host3", 4003), ("host4", 4004))
    val servers = Seq(srv1, srv2, srv3, srv4)
  ...
  test("pickPreferredGeodeServers: no io.snappydata.spark.gemfire.connector.internal.gemfirefunctions.shared servers, one gf-server per host, and less gf-server") {
